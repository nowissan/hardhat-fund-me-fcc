...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", async function () {
          ...
          beforeEach(async function () {
              ...
              // const accounts = await ethers.getSigner() // will return the account defined in the confg
              deployer = (await getNamedAccounts()).deployer
              await deployments.fixture(["all"])
              fundMe = await ethers.getContract("FundMe", deployer) // will get the last contract deployed
